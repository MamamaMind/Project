...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Room Listings' subtitle='View, edit, and manage all listed rooms. Keep information up to date to deliver the best user experience.'/>

      <p className='text-gray-500 mt-8 mb-3'>All Rooms</p>
      <div className='w-full max-w-6xl justtext-left border border-gray-300 rounded-lg max-h-150 overflow-y-scroll mt-3'>
          ...
          <tbody className='text-sm'>
            {
              rooms.map((item, index)=>(
                <tr key={index}>
                  ...
                  <td className='py-4 px-4  text-gray-700 border-t border-gray-300 max-sm:hidden text-center'>
